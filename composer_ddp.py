...
trainset = torchvision.datasets.CIFAR10(root='/root/data', train=True, download=True, transform=transform)
testset = torchvision.datasets.CIFAR10(root='/root/data', train=False, download=True, transform=transform)
