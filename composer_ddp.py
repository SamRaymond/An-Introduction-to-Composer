...
trainset = torchvision.datasets.CIFAR10(root='/tmp/dataset/train/', train=True, download=True, transform=transform)
testset = torchvision.datasets.CIFAR10(root='/tmp/dataset/test/', train=False, download=True, transform=transform)
