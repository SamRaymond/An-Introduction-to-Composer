...
trainset = torchvision.datasets.CIFAR10(root='/root/dataset/train/', train=True, download=True, transform=transform)
testset = torchvision.datasets.CIFAR10(root='/root/dataset/test/', train=False, download=True, transform=transform)
