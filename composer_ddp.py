...
trainset = torchvision.datasets.CIFAR10(root='./my_data', train=True, download=True, transform=transform)
testset = torchvision.datasets.CIFAR10(root='./my_data', train=False, download=True, transform=transform)
dist.barrier()
